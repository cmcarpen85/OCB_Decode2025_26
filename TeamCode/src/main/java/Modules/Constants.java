...
public class Constants {
    ...
    public static double FARSHOTHOODSERVO = 0;
...
public static double TURRETMINANGLE = -150;
...
public static double FARSHOTTURRETANGLE = 130;
    public static double FARSHOTTURRETSERVO = .6;
