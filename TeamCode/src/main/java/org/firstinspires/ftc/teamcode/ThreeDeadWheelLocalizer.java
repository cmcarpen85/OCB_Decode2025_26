...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2989.5378; // y position of the first parallel encoder (in tick units) calculated -3130.90
        public double par1YTicks = 3055.84481; // y position of the second parallel encoder (in tick units) calculated 3130.90
        public double perpXTicks = -969.21016; // x position of the perpendicular encoder (in tick units) calculated -1056.36
    }
