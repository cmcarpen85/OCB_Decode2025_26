...
public class Shoota {
    ...
    static LUT<Double, Double> speeds = new LUT<Double, Double>() {{
        ...
        add(119.0,0.5735);
        // Far Zone
        add(129.0, 0.5756); // 0.59
        add(130.0, 0.586); // 0.59
        add(132.0, 0.588); // 0.59
        add(134.0, 0.590); // 0.598
        add(135.0, 0.593); // 0.59
        add(138.0, 0.604); // 0.608
        add(141.0, 0.604); // 0.59
        add(143.0, 0.610); // 0.608
        add(146.0, 0.615); // 0.6122
        add(148.0, 0.617); // 0.6073
        add(150.0, 0.6172); // 0.6285
        add(152.0, 0.6188); // 0.6285
        add(154.0, 0.620); // 0.63
        add(156.0, 0.625); // 0.59
        add(158.0, 0.6364); // 0.6314
        add(160.0, 0.637); // 0.6314
    }};
