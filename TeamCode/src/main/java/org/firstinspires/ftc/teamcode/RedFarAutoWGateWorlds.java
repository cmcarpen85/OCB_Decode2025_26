...
public class RedFarAutoWGateWorlds extends LinearOpMode {
    ...
    public static class Params {
        ...
        public double intakeDriveMidY = 16.1* Color;
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder PickMidSpikeMark = drive.actionBuilder(startPos)
                ...
                .lineToYConstantHeading(PARAMS.pickMidSMY +  PARAMS.intakeDriveMidY, new TranslationalVelConstraint(40), new ProfileAccelConstraint(-30, 30))
                .splineToConstantHeading(new Vector2d(PARAMS.openGateX, PARAMS.openGateY), Math.toRadians(PARAMS.openGateOri), new TranslationalVelConstraint(15), new ProfileAccelConstraint(-30, 30));
        ...
        TrajectoryActionBuilder PickCloseSpikeMark = drive.actionBuilder(shootPos)
                ...
                .splineToConstantHeading(new Vector2d(PARAMS.pickCloseSMX, PARAMS.pickCloseSMY + PARAMS.intakeDriveCloseY), PARAMS.pickCloseSMX);

        TrajectoryActionBuilder DriveToShootClose = drive.actionBuilder(new Pose2d(PARAMS.pickCloseSMX, PARAMS.pickCloseSMY + PARAMS.intakeDriveMidY, Math.toRadians(90* PARAMS.Color)))
                .setTangent(Math.toRadians(-90* PARAMS.Color))
                .splineToLinearHeading(new Pose2d(PARAMS.shoot1X, PARAMS.shoot1Y, Math.toRadians(PARAMS.shoot1Ori)), Math.toRadians(-180* PARAMS.Color), new TranslationalVelConstraint(40), new ProfileAccelConstraint(-30, 60));
